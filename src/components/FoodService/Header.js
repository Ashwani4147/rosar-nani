...
function Header() {
  ...
  const navLinks = [
    { name: t("Welcome to Food Service"), href: "home", type: "section" },
...
//   // Main nav links
//   const navLinks = [
//     { name: t("Welcome to Food Service"), href: "/" },
//     { name: t("about"), href: "/about" },
//     { name: t("services"), href: "/services" },
//     { name: "Categories", href: "/categories" },
//     { name: "Quality You Can Trust", href: "/quality" },
//     { name: "Contact Us", href: "/contact" },
//   ];

//   // Service sub-links (new pages)
//   const serviceSubLinks = [
//     { name: "Food Service", href: "/food" },
//     { name: "Salon Service", href: "/salon" },
//     { name: "Cosmetics Service", href: "/cosmetics" },
//   ];
...
//       ) {
//         setIsMenuOpen(false);
//         setIsServicesOpenMobile(false); // reset services dropdown when clicking outside
//       }
//     };
//     document.addEventListener("mousedown", handleClickOutside);
//     return () => document.removeEventListener("mousedown", handleClickOutside);
...
//                   ref={servicesButtonRef}
//                   onClick={() =>
//                     setIsServicesClickedDesktop((prev) => !prev)
//                   }
//                   className={`font-medium transition-colors duration-300 hover:scale-105 ${
//                     location.pathname === link.href
//                       ? "text-[#419fa4] border-b-2 border-[#419fa4] font-semibold"
...
//                   <button
//                     onClick={() =>
//                       setIsServicesOpenMobile((prev) => !prev)
//                     }
//                     className={`w-full text-center py-3 text-lg transition-colors duration-300 ${
//                       isServicesOpenMobile
//                         ? "text-[#419fa4] bg-gray-100 font-bold"
...
//                           onClick={() => {
//                             setIsMenuOpen(false);
//                             setIsServicesOpenMobile(false); // reset when navigating
//                           }}
//                         >
//                           {subLink.name}
//                         </Link>
