...
//     e.preventDefault();
//     if (!validate()) return; // prevent submit if there are validation errors
...
//     !formData.name || !formData.email || !formData.message || Object.values(errors).some((x) => x !== "");
